...
/** Put function, unsigned int to binary conversion, process unsigned integer input */
...
/** Standard Library putchar emulator, write character input to standard output */
int _putchar(char c);
...
/** Standard Library printf emulator. Variadic function to print any format data to standard output */
